<div class="box">
    <div class="box-header">
        <div class="left">
            ...
            <br>
            <small class="pull-left">Sadece kayıtlı kullanıcıları görebilirsiniz</small>
        </div>
    </div><!-- /.box-header -->
                                            ...
                                            <li>
                                                <a class="p0">
                                                    <button type="button" class="btn-list-button" data-toggle="modal"
                                                        ...
                                                        <i class="fa fa-user i-edit"></i>Kullanıcı Rolünü Değiştir
                                                    </button>
                                                </a>
                                            </li>
                                            <li>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label class="control-label">Yeni Rol Seç</label>
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <label for="role_admin" class="option-label">Yönetici</label>

                        </div>
                        <div class="col-sm-4">
                            <input type="radio" name="role" value="editor" id="role_editor"
                                   class="flat-orange" required>
                            <label for="role_editor" class="option-label">Yazar</label>

                        </div>
                        <div class="col-sm-4">
                            <input type="radio" name="role" value="user" id="role_user"
                                   class="flat-orange" required>
                            <label for="role_user" class="option-label">Kullanıcı</label>
