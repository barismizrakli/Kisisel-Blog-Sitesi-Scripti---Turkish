<div class="box">
    <div class="box-header">
        <div class="left">
            ...
            <br>
            <small class="pull-left">Burada mesajları görebilirsiniz.</small>
        </div>
    </div><!-- /.box-header -->
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped dataTable" id="cs_datatable" role="grid"
                        ...
                        <tr role="row">
                            ...
                            <th>Görünürlük</th>
                            <th>Kaydırıcı</th>
                            <th style="max-width: 40px;">Kaydırıcı Durumu</th>
                            <th>Tarih</th>
                                        ...
                                        <ul class="dropdown-menu pull-right options-list">
                                                ...
                                                <li>
                                                    <a class="p0">
                                                        <button type="submit" name="option" value="add_delete_slider"
                                                            ...
                                                            <i class="fa fa-minus"></i>Kaydırıcıdan Kaldır
                                                        </button>
                                                    </a>
                                                </li>
                                            <?php else: ?>
                                                <li>
                                                    <a class="p0">
                                                        <button type="submit" name="option" value="add_delete_slider"
                                                                class="btn-list-button">
                                                            <i class="fa fa-plus"></i>Kaydırıcı Ekle
                                                        </button>
                                                    </a>
                                                </li>
                                            <?php endif; ?>
                                            ...
                                            <li>
                                                <a href="<?php echo base_url(); ?>admin/update-post/<?php echo html_escape($item->id); ?>">
                                                    <i class="fa fa-edit i-edit"></i>Düzenle</a></li>
                                            <li>
                                                <a class="p0">
