...
<div class="row">
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-aqua">
            ...
            <a href="<?php echo base_url(); ?>admin/posts" class="small-box-footer">Daha Fazla Bilgi <i
    ...
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-green">
            ...
            <a href="<?php echo base_url(); ?>admin/categories" class="small-box-footer">Daha Fazla Bilgi <i
                        class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div><!-- ./col -->
    ...
    <?php if (is_admin()): ?>
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-red">
                ...
                <a href="<?php echo base_url(); ?>admin/comments" class="small-box-footer">Daha Fazla Bilgi <i
                            class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div><!-- ./col -->
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-yellow">
                ...
                <a href="<?php echo base_url(); ?>admin/users" class="small-box-footer">Daha Fazla Bilgi <i
                            class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div><!-- ./col -->
    <?php endif; ?>
...
<div class="row">
    <div class="col-sm-12 no-padding">
            ...
            <div class="col-lg-6 col-sm-12 col-xs-12">
                <div class="box box-primary">
                    <div class="box-header">
                        ...
                        <br>
                        <small>Burada Son Yorumları görebilirsiniz</small>
                        ...
                        <div class="table-responsive">
                            <table class="table no-margin">
                                ...
                                <tr>
                                    ...
                                    <th style="min-width: 13%">Tarih</th>
                                </tr>
                                </thead>
                                <tbody>
                    ...
                    <div class="box-footer clearfix">
                        <a href="<?php echo base_url(); ?>admin/comments"
                           class="btn btn-sm btn-default btn-flat pull-right">Tüm Yorumları Görüntüle</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-sm-12 col-xs-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Son İletişim Mesajları</h3>
                        <br>
                        <small>Burada Son İletişim Mesajlarını görebilirsiniz</small>
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-box-tool" data-widget="collapse"><i
                                        class="fa fa-minus"></i>
                            </button>
                    ...
                    <div class="box-footer clearfix">
                        <a href="<?php echo base_url(); ?>admin/contact-messages"
                           class="btn btn-sm btn-default btn-flat pull-right">Tüm İletişim Mesajlarını Göster</a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-6 col-sm-12 col-xs-12">
            ...
            <div class="box box-danger">
                <div class="box-header with-border">
                    <h3 class="box-title">Son Kullanıcılar</h3>
                    <br>
                    <small>Burada son kayıt olan kullanıcıları görebilirsiniz</small>
                    <div class="box-tools pull-right">
                        <button type="button" class="btn btn-box-tool" data-widget="collapse"><i
                                    class="fa fa-minus"></i>
                        </button>
                ...
                <div class="box-footer text-center">
                    <a href="<?php echo base_url(); ?>admin/users" class="btn btn-sm btn-default btn-flat pull-right">Tüm Kullanıcılar Göster</a>
                </div>
                <!-- /.box-footer -->
            </div>
            <!--/.box -->
