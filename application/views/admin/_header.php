...
<head>
    ...
    <title><?php echo html_escape($title); ?> - Admin Paneliniz</title>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                <li class="header">Ana Yönledirici</li>
                <li>
                ...
                <?php if (is_admin()): ?>
                    <li class="treeview">
                        <a href="#">
                            <i class="fa fa-leaf"></i> <span>Sayfalar</span> <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                            <li class="active">
                                <a href="<?php echo base_url(); ?>admin/add-page">
                                    <i class="fa fa-circle-o"></i> Yeni Sayfa Ekle
                                </a>
                            </li>
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-file"></i> <span>Gönderiler</span> <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                        <li class="active">
                            <a href="<?php echo base_url(); ?>admin/add-post">
                                <i class="fa fa-circle-o"></i> Yeni Gönderi Ekle
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo base_url(); ?>admin/posts"><i class="fa fa-circle-o"></i> Gönderi
                            </a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="<?php echo base_url(); ?>admin/categories">
                        <i class="fa fa-folder-open"></i> <span>Kategoriler</span>
                    </a>
                </li>
                ...
                <?php if (is_admin()): ?>
                    <li class="treeview">
                        <a href="#">
                            <i class="fa fa-image"></i> <span>Fotoğraf Galeri</span>
                            <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                            <li>
                                <a href="<?php echo base_url(); ?>admin/gallery-categories">
                                    <i class="fa fa-circle-o"></i> Kategoriler
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>admin/photo-gallery">
                                    <i class="fa fa-circle-o"></i> Fotoğraflar
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>admin/font-options"><i class="fa fa-font" aria-hidden="true"></i>
                            <span>Yazı Tipi Seçenekleri</span>
                        </a>
                    </li>
                    <li>
